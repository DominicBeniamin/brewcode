...
function abv({
    ...
    const originalSg = convertDensity(originalCorrected, densityScale, "sg");
    const finalSg = convertDensity(finalCorrected, densityScale, "sg");
...
function priming({
    ...
    const tempC = convertTemperature(beverageTemp, tempScaleNorm, "c");
